...
select_arch_from_table() {
    ...
    # - It tells read (and other shell parsing tools) how to split a line into words or fields
    # - By default, IFS includes space, tab, and newline
    # - Here, set it to '|' because input table uses '|' as a separator
...
x86-64-avx512|match_flags|avx512f avx512bw avx512dq avx512vl
