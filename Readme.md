...
DON has support for 32/64-bit CPUs, the hardware USE_POPCNT/USE_BMI2 instruction,
...
sessions suffer from memory fragmentation which may prevent DON
...
need to manually set/unset some switches in the compiler command line;
see file *type.h* for a quick reference.
