...
//void order (ValMoveList &vm_list, bool full)
//{
//    size_t beg = 0;
//    size_t end = vm_list.size ();
//
//    size_t max = beg;
//    for (size_t i = beg; i < end; ++i)
//    {
//        if (vm_list[i] > vm_list[max])
//        {
//            max = i;
//        }
//    }
...
//    if (full || beg < max)
//    {
//        std::swap (vm_list[beg], vm_list[max]);
//        ++beg;
//
//        for (size_t i = beg + 1; i < end; ++i)
//        {
//            ValMove tmp = vm_list[i];
//
//            max = i - 1;
//            if (tmp <= vm_list[max]) continue;
//            while (beg <= max && tmp > vm_list[max])
//            {
//                vm_list[max + 1] = vm_list[max];
//                --max;
//            }
//            vm_list[max + 1] = tmp;
//        }
