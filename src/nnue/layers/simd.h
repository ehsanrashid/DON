...
[[maybe_unused]] static int m256_hadd(__m256i sum, int bias) noexcept {
    __m128i sum128;
    sum128 = _mm_add_epi32(_mm256_castsi256_si128(sum), _mm256_extracti128_si256(sum, 1));
...
[[maybe_unused]] static void m256_add_dpbusd_epi32(__m256i& acc, __m256i a, __m256i b) noexcept {
    ...
    #else
    __m256i product0;
    product0 = _mm256_maddubs_epi16(a, b);
...
[[maybe_unused]] static void m128_add_dpbusd_epi32(__m128i& acc, __m128i a, __m128i b) noexcept {
    ...
    __m128i product0;
    product0 = _mm_maddubs_epi16(a, b);
...
neon_m128_add_dpbusd_epi32(int32x4_t& acc, int8x16_t a, int8x16_t b) noexcept {
    ...
    int16x8_t product1;
    int16x8_t sum;
    product0 = vmull_s8(vget_low_s8(a), vget_low_s8(b));
    product1 = vmull_high_s8(a, b);
    sum      = vpaddq_s16(product0, product1);
