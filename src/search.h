...
class Worker final {
   ...
   private:
    ...
    void update_histories(const Position& pos, PawnHistory& pawnHistory, Stack* ss, Depth depth, Move bestMove, bool ttm, const StdArray<SearchedMoves, 2>& searchedMoves) noexcept;
