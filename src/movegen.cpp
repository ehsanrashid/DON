...
Move* splat_pawn_moves(Bitboard dstBB, Move* RESTRICT moves) noexcept {
    ...
    // clang-format off
    __m128i dstSquares = _mm_cvtepi8_epi16(_mm512_castsi512_si128(_mm512_maskz_compress_epi8(dstBB, AllSquares)));
    __m128i orgSquares = _mm_sub_epi16(dstSquares, _mm_set1_epi16(+D));
...
Move* splat_moves(Square orgSq, Bitboard dstBB, Move* RESTRICT moves) noexcept {
    ...
    __m512i dstSquares = _mm512_cvtepi8_epi16(_mm512_castsi512_si256(_mm512_maskz_compress_epi8(dstBB, AllSquares)));
